      ...
      <div className="px-5">
        <Tabs defaultValue="leitura" className="w-full">
          <TabsList className="w-full bg-muted/30 rounded-2xl p-1 mb-4">
            <TabsTrigger value="leitura" className="flex-1 rounded-xl text-xs font-body data-[state=active]:bg-gold/20 data-[state=active]:text-gold">
              <BookOpen className="h-3.5 w-3.5 mr-1.5" />
              Leitura
            </TabsTrigger>
            <TabsTrigger value="historico" className="flex-1 rounded-xl text-xs font-body data-[state=active]:bg-gold/20 data-[state=active]:text-gold">
          ...
          <TabsContent value="leitura" className="space-y-4 mt-0">
            ...
            >
              ...
              {!showNeuro && (
                <p className="text-[11px] text-muted-foreground font-body">Toque para revelar o insight científico sobre esta passagem</p>
              )}
            </button>
          ...
          <TabsContent value="historico" className="mt-0">
            <BibleHistoryCalendar
              ...
              onSelectDay={(day) => { setSelectedDay(day); setShowNeuro(false); }}
            />
          </TabsContent>
        </Tabs>
      </div>

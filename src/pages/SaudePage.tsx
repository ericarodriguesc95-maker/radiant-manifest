...
export default function SaudePage() {
  ...
  const heightInCm = profile.height_cm ? (profile.height_cm > 3 ? profile.height_cm : profile.height_cm * 100) : null;
  const tmb = profile.current_weight && heightInCm && profile.age ? calculateTMB(profile.current_weight, heightInCm, profile.age, profile.sex) : null;
  ...
  return (
    ...
    <div className="min-h-screen pb-20 pt-6 px-4 max-w-2xl mx-auto">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="gap-4 sm:gap-6 px-1">
          <TabsTrigger value="perfil">⚖️ Meu corpo</TabsTrigger>
          <TabsTrigger value="dieta">🍽️ O que comi</TabsTrigger>
          <TabsTrigger value="nutri">🥗 IA Nutri</TabsTrigger>
          <TabsTrigger value="treino">💪 Treino</TabsTrigger>
          <TabsTrigger value="suplem">💊 Suplem.</TabsTrigger>
          <TabsTrigger value="ciclo">🩸 Meu ciclo</TabsTrigger>
